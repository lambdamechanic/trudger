...
- [ ] 1.7 Externalize all task commands (`next_task`, `task_show`, `task_update_in_progress`) into config.
- [ ] 1.8 Update sample configs to include `commands.*` entries.
- [ ] 1.9 Update tests to use configured command wrappers for show/update.
- [ ] 1.10 Update README to document the command expectations and exit code semantics.

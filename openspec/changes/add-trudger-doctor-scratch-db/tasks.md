...
- [ ] 1.5 Add tests that assert doctor setup hook invocation, env var behavior, full config validation, cleanup, cleanup failure behavior, error messaging, and sample config conformance.
